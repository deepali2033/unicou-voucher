...
<body>
    ...
    <div id="pageLoader">
        <div class="loader-content">
            <div class="loader-logo">
                <img src="https://tfpadvisory.bkhomesolutionindore.com/wp-content/uploads/2026/01/Untitled-design-2026-01-16T192538.285.png" alt="unicou logo">
            </div>
            <p class="loader-text">
    ...
    <div class="floatingNav scroll">
        ...
        <div class="listItem Sec2" data-target="Sec2"><span>GLOBAL AUDIENCE <br> InUni</span></div>
        <div class="listItem Sec3" data-target="Sec3"><span>Global <br> Presence</span></div>
        <div class="listItem Sec4" data-target="Sec4"><span> UNICOU <br> LEARNING HUB <br> &amp; Partners</span></div>
        <div class="listItem Sec5" data-target="Sec5"><span>The InUni <br> Philosophy</span></div>
        <div class="listItem Sec6" data-target="Sec6"><span>Steps</span></div>
        <div class="listItem Sec7" data-target="Sec7"><span>Testimonials</span></div>
    </div>
    ...
    <section class="hero-section padding_top_bot Sec1" id="Sec1">
        ...
        <div class="container">
            <div class="hero-container">
                ...
                <div class="hero-media">
                    <img src="https://tfpadvisory.bkhomesolutionindore.com/wp-content/uploads/2026/01/book-png-image.png" alt="Learning Hub Graphic">
                </div>
    ...
    <section class="learning-platform padding_top_bot Sec2" id="Sec2">
        <div class="container">
            <div class="lp-container">
                ...
                <!-- RIGHT IMAGE -->
                <div class="lp-image">
                    <img src="./globe img.png" alt="Global Network">
    ...
    <section class="exam-section padding_top_bot Sec5" id="Sec5">
        <div class="container">
            ...
            <div class="card-container">
                <div class="card">
                    <img src="https://tfpadvisory.bkhomesolutionindore.com/wp-content/uploads/2026/01/pearson.jpeg" alt="PTE">
                    <p class="small">PTE AUTHORIZED</p>
                    <h4>PTE VOUCHER</h4>
                </div>

                <div class="card">
                    <img src="https://tfpadvisory.bkhomesolutionindore.com/wp-content/uploads/2026/01/ielts.jpeg" alt="IELTS">
                    <p class="small">IELTS AUTHORIZED</p>
                    <h4>IELTS VOUCHER</h4>
                </div>

                <div class="card">
                    <img src="https://tfpadvisory.bkhomesolutionindore.com/wp-content/uploads/2026/01/toefl.jpeg" alt="TOEFL">
                    <p class="small">TOEFL AUTHORIZED</p>
                    <h4>TOEFL iBT VOUCHER</h4>
                </div>

                <div class="card">
                    <img src="https://tfpadvisory.bkhomesolutionindore.com/wp-content/uploads/2026/01/language-cert.jpeg" alt="LanguageCert">
                    <p class="small">LanguageCert</p>
                    <h4>LANGUAGECERT ENGLISH TEST</h4>
                </div>

                <div class="card">
                    <img src="https://tfpadvisory.bkhomesolutionindore.com/wp-content/uploads/2026/01/skills-for-eng.jpeg" alt="Skills">
    ...
    <section class="who-section padding_top_bot Sec7" id="Sec7">
        <div class="container">
            <div class="who-container">
                ...
                <!-- RIGHT IMAGE -->
                <div class="who-image">
                    <img src="https://tfpadvisory.bkhomesolutionindore.com/wp-content/uploads/2025/12/How-we-partner.png" alt="Professional Meeting">
                </div>
...
<div class="side-menu" id="sideMenu">
  ...
  <div class="menu-footer">
    <div class="btn-group login-reg">
      <a href="#" class="btn primary-btn">Login</a>
      <a href="#" class="btn secondary-btn">Registration</a>
    </div>
  </div>
</div>
