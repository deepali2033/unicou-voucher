        ...
        <div class="v-card">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-baseline mb-3">
                        ...
                        @if($v->original_price > 0)
                            <span class="v-old-price">{{ $v->currency }} {{ number_format($v->original_price) }}</span>
                        @endif
                    </div>
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.inventory.edit', $v->id) }}" class="v-btn-edit text-center text-decoration-none">
            ...
            <div class="v-footer">
                <div class="d-flex align-items-center">
                    ...
                    {{ $v->quarterly_points }} Quarterly
                </div>
                <div class="d-flex align-items-center">
                    <span class="me-1">🏷️</span>
                    {{ $v->yearly_points }} Yearly
                </div>
            </div>
        </div>
    </div>
