...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.vouchers.export') }}" class="btn btn-outline-secondary rounded-pill px-3">
                <i class="fas fa-file-csv me-1"></i> Export CSV
            </a>
            <button class="btn btn-outline-secondary rounded-pill px-3" data-bs-toggle="modal" data-bs-target="#importModal">
                <i class="fas fa-file-import me-1"></i> Import CSV
            </button>
            <a href="{{ route('admin.vouchers.create') }}" class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm">
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
        <div class="card-body p-3">
            <form action="{{ route('admin.vouchers.control') }}" method="GET" class="row g-3 align-items-center">
                <div class="col-md-3">
                ...
                <div class="card-body p-4 flex-grow-1">
                    <div class="row g-3">
                        ...
                        <div class="col-7">
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('admin.vouchers.edit', $voucher->id) }}" class="btn btn-edit flex-grow-1">
