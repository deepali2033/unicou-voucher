        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 border-start border-primary border-4">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="fw-bold mb-0">{{ $voucher->agent_referral_points_per_unit}}</h3>
                        <span class="ms-auto text-success small fw-bold"><i class="fas fa-arrow-up me-1"></i>12%</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 border-start border-primary border-4">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="fw-bold mb-0">{{ $voucher->agent_bonus_points_per_unit }} <!-- InventoryVoucher --></h3>
                        <span class="ms-auto text-success small fw-bold"><i class="fas fa-arrow-up me-1"></i>12%</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 border-start border-primary border-4">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="fw-bold mb-0">{{ $voucher->student_referral_points_per_unit}}</h3>
                        <span class="ms-auto text-success small fw-bold"><i class="fas fa-arrow-up me-1"></i>12%</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 border-start border-primary border-4">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="fw-bold mb-0">{{ $voucher->student_bonus_points_per_unit }} <!-- InventoryVoucher --></h3>
                        <span class="ms-auto text-success small fw-bold"><i class="fas fa-arrow-up me-1"></i>12%</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 border-start border-primary border-4">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="fw-bold mb-0">{{ $voucher->referral_points_reseller}}</h3>
                        <span class="ms-auto text-success small fw-bold"><i class="fas fa-arrow-up me-1"></i>12%</span>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4 pb-4 border-bottom">
                        <div class="d-flex align-items-center">
                            <div class="brand-logo-container me-3">
                                @if($voucher->logo)
                                <img src="{{ asset('storage/'.$voucher->logo) }}" alt="{{ $voucher->brand_name }}" class="img-fluid">
                                @else
                                <i class="fas fa-ticket-alt fa-2x text-primary"></i>
                                @endif
                            </div>
                            <div>
                                <h5 class="fw-bold mb-0">{{ $voucher->brand_name }}</h5>
                        ...
                        <div class="quantity-selector d-flex align-items-center bg-light rounded-pill px-2 py-1">
                            ...
                            <input type="number" id="voucher-quantity" class="form-control form-control-sm bg-transparent border-0 text-center fw-bold" value="1" min="1" max="{{ $voucher->quantity }}" style="width: 50px;">
                    ...
                    <div class="price-details-table mb-4">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-bold">{{ $voucher->currency }} <span id="unit-price">{{ number_format($rule->final_price, 0) }}</span></span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="d-flex justify-content-between mb-3 pb-3 border-bottom">
                            ...
                            <span class="fw-bold">{{ $voucher->currency }} <span id="subtotal">{{ number_format($rule->final_price, 0) }}</span></span>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <h3 class="fw-bold text-primary mb-0">{{ $voucher->currency }} <span id="final-total">{{ number_format($rule->final_price, 0) }}</span></h3>
                        </div>
                    ...
                    <div class="progress-ring-container mb-4">
                        <div class="brand-progress-header d-flex align-items-center justify-content-center mb-3">
                            <div class="brand-logo-sm me-2">
                                @if($voucher->logo)
                                <img src="{{ asset('storage/'.$voucher->logo) }}" alt="" style="height: 20px;">
                                @endif
                            </div>
                            <span class="fw-bold small">{{ $voucher->brand_name }}</span>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="earning-item p-2 rounded-3">
                                ...
                                <h6 class="fw-bold text-dark mb-0"><span id="display-q-points">
                                        ...
                                        {{ $voucher->student_referral_points_per_unit }}
                                        @else
                                        {{ $voucher->agent_referral_points_per_unit }}
                                        @endif
                                    </span> RS</h6>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="earning-item p-2 rounded-3">
                                ...
                                <h6 class="fw-bold text-dark mb-0"><span id="display-y-points">
                                        @if(auth()->user()->account_type == 'student')
                                        {{ $voucher->student_bonus_points_per_unit }}
                                        @else
                                        {{ $voucher->agent_bonus_points_per_unit }}
                                        @endif
                                    </span> RS</h6>
                            </div>
                        </div>
