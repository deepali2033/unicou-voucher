    ...
    <div class="login-form">
        ...
        <form id="reset-password-form" action="{{ route('password.update') }}" method="POST">
            ...
            <div class="field">
                ...
                <input type="email" name="email" value="{{ $email ?? old('email') }}" placeholder="Enter email" required>
            ...
            <button type="submit" class="login_btn" id="submit-btn">Reset Password</button>
