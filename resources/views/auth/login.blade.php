...
@section('title', 'Login - KAO services for Professional Cleaning Services')
@section('meta_description', 'Login to your KAO services account to manage bookings and services.')

@section('content')
<div class="auth-container">
    <h2 class="text-center mt-2 mb-4">Lofsdrfsdfgin</h2>
    ...
    <form id="loginForm" method="POST" action="{{ route('auth.login') }}">
        ...
        <div class="mb-3 form-check d-flex align-items-center gap-2">
            <!-- Hidden input ensures a '0' is submitted when unchecked -->
            <input type="hidden" name="remember" value="0">
            <input type="checkbox" class="" id="remember" name="remember" value="1" {{ old('remember') ? 'checked' : '' }}>
        ...
        <button type="submit" class="btn btn-auth w-100" id="submitBtn">Login</button>
