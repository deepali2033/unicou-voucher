...
<div class="sat-view-container">
    <div class="sat-card">
        ...
        <div class="sat-consent cls_radio_btn">
            <input type="radio" name="agentType" required>
            <p>Regular Agent</p>
        </div>
        ...
        <div class="sat-field">
            ...
            <input type="text" placeholder="Registered business name" required>
        </div>
        ...
        <div class="sat-field">
            ...
            <input type="text" placeholder="Registration / Incorporation No" required>
        </div>

        <div class="sat-field">
            <label>Contact Number *</label>
            <input type="tel" placeholder="+CountryCode Business Contact" required>
        </div>

        <div class="sat-field">
            <label>Email (Voucher Delivery) *</label>
            <input type="email" placeholder="official@business.com" required>
        </div>
        </div>
        </section>
        ...
        <div class="sat-field sat-full">
            ...
            <input type="text" placeholder="Office / Shop address" required>
        </div>
        ...
        <div class="sat-field">
            ...
            <input type="url" placeholder="https://facebook.com / linkedin.com">
        </div>
        </div>
        </section>
        ...
        <div class="sat-field">
            ...
            <input type="text" placeholder="Full name as per ID" required>
        </div>
        ...
        <div class="sat-field">
            ...
            <input type="text" placeholder="Country of bank" required>
        </div>

        <div class="sat-field sat-full">
            <label>IBAN / BSB / Account Number *</label>
            <input type="text" placeholder="IBAN / Account number" required>
        </div>
        </div>
        </section>
