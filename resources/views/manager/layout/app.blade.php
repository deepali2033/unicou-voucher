...
<head>
    ...
    <title>Manager Dashboard - UniCou</title>
    <!-- Bootstrap CSS -->
            ...
            <nav id="sidebar" class="col-md-3 col-lg-3 sidebar sidebar-hidden">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column gap-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('manager.audit') ? 'active' : '' }}"
                                href="{{ route('manager.audit') }}">
                                <i class="fas fa-search-dollar me-2"></i> Audit Transactions
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('manager.vouchers.stock') ? 'active' : '' }}"
                                href="{{ route('manager.vouchers.stock') }}">
                                <i class="fas fa-cubes me-2"></i> Voucher Stocks
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('manager.disputes') ? 'active' : '' }}"
                                href="{{ route('manager.disputes') }}">
                                <i class="fas fa-gavel me-2"></i> Disputes & Refunds
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('manager.system.stop') ? 'active' : '' }}"
                                href="{{ route('manager.system.stop') }}">
                                <i class="fas fa-stop-circle me-2"></i> Stop System
                            </a>
                        </li>
